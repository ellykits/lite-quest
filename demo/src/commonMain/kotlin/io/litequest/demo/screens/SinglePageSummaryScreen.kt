...
import io.litequest.demo.SinglePageViewModel
...
@Composable
fun SinglePageSummaryScreen(
  onBack: () -> Unit,
  initialMode: QuestionnaireMode = QuestionnaireMode.Summary,
) {
  ...
  val submittedJson by viewModel.submittedJson.collectAsState(initial = null)
  val manager by viewModel.manager.collectAsState()

  LaunchedEffect(Unit) { viewModel.populateForSummary() }
